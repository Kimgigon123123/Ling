			...
			<div class="col-lg-6">
				...
				<div class="masthead-device-mockup">
					...
					<svg class="shape-2 d-none d-sm-block" viewBox="0 0 100 100"
						...
						<circle cx="50" cy="50" r="50"></circle></svg>
					<div class="container">
						<div class="container" data-device="iPhoneX"
							data-orientation="portrait" data-color="black">
							<div id="carouselExample" class="carousel slide"
								data-bs-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img src="<c:url value='/resources/images/couple.jpg'/>"
											class="d-block" width="600px" height="600px" alt="Image 1">
									</div>
									<div class="carousel-item">
										<img
											src="<c:url value='/resources/images/ling_app_main.png'/>"
											class="d-block" width="600px" height="600px" alt="Image 2">
									</div>
									<div class="carousel-item">
										<img src="<c:url value='/resources/images/ling_slogun.png'/>"
											class="d-block" width="600px" height="600px" alt="Image 3">
									</div>
								</div>
							</div>
						</div>
...
<aside class="text-center bg-gradient-primary-to-secondary">
	<div class="container px-5">
		<div class="row gx-5 justify-content-center">
			<div class="col-xl-8">
				<div class="h2 fs-1 text-white mb-auto">
					"내 짝궁과 늘 예쁘게 웃을 수 있는 세상은 <br> 바로 지금입니다. (LING♡)"
				</div>
				...
				<div class="container-fluid px-5">
					<div class="row gx-5">
						<div class="col-md-6 mb-5">
							...
							<div class="text-center">
								<img
									src="<c:url value='/resources/images/menu_homefrag_img1.png'/>"
									class="justify-content-center w-50 h-50" alt="Image 2">
						...
						<div class="col-md-6 mb-5">
							...
							<div class="text-center">
								<img
									src="<c:url value='/resources/images/menu_homefrag_img3.png'/>"
									class="justify-content-between w-50 h-50" alt="Image 2">
					...
					<div class="row">
						<div class="col-md-6 mb-5 mb-md-0">
							...
							<div class="text-center">
								<img
									src="<c:url value='/resources/images/menu_homefrag_img2.png'/>"
									class="justify-content-between w-50 h-50" alt="Image 2">
						...
						<div class="col-md-6">
							...
							<div class="text-center">
								<img
									src="<c:url value='/resources/images/menu_homefrag_img4.png'/>"
									class="justify-content-center w-50 h-50" alt="Image 2">
								<h3 class="font-alt">타입캡슐</h3>
								<p class="text-muted mb-0">Since this theme is MIT licensed,
									you can use it commercially!</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="cta-content">
		<div class="container px-5">
			<h2 class="text-white display-1 lh-1 mb-4">
				Couple Playground <br /> With My Partner With LING.
			</h2>
			<a class="btn btn-outline-light py-3 px-4 rounded-pill" href="#"
				target="_blank">커플 밸런스 게임하러가기</a>
		</div>
	</div>
</section>
<!-- App badge section-->
	...
	<div class="container px-5">
		...
		<div
			...
			<a class="me-lg-3 mb-4 mb-lg-0"
				href="https://www.apple.com/kr/app-store/"><img
				class="app-badge" src="img/google-play-badge.svg" alt="..." /></a> <a
				...
				class="app-badge" src="img/app-store-badge.svg" alt="..." /></a>
		</div>
	</div>
</section>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header bg-gradient-primary-to-secondary p-4">
				<h5 class="modal-title font-alt text-white" id="feedbackModalLabel">Send
					feedback</h5>
