...
//            ll.setBackgroundColor(Color.BLACK);
        ...
        binding.tvDr.setOnClickListener(v->{
            ...
            transaction.replace(R.id.etc, storeDrFragment);
        ...
        binding.tvRing.setOnClickListener(v->{
            ...
            transaction.replace(R.id.etc, storeRiFragment);
        ...
        binding.tvGift.setOnClickListener(v->{
            ...
            transaction.replace(R.id.etc, storeGiFragment);
        ...
        binding.tvEtc.setOnClickListener(v->{
            ...
            transaction.replace(R.id.etc, storeEtcFragment);
    ...
    public void select() {
        CommonConn conn = new CommonConn(getContext(), "store_etc_byrecent");
    ...
    public void by_name() {
        CommonConn conn = new CommonConn(getContext(), "store_etc_byname");
        conn.onExcute((isResult, data) -> {
    ...
    public void by_popular() {
        CommonConn conn = new CommonConn(getContext(), "store_etc_bypopular");
        conn.onExcute((isResult, data) -> {
    ...
    public void by_price() {
        CommonConn conn = new CommonConn(getContext(), "store_etc_byprice");
        conn.onExcute((isResult, data) -> {
