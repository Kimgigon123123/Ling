...
public class DateDibsVO {
	...
	private String id, date_category_code, date_name, date_address, date_intro, open, end, lan, lng, date_img;
	...
	public void setDibs_id(int dibs_id) {
		this.dibs_id = dibs_id;
	}
