...
public class StoreDrFragment extends Fragment {
...
//            ll.setBackgroundColor(Color.BLACK);
        ...
        binding.tvHome.setOnClickListener(v -> {
            ...
            transaction.replace(R.id.dr, newFragment);
        ...
        binding.tvAll.setOnClickListener(v -> {
            ...
            transaction.replace(R.id.dr, storeCoFragment);
        ...
        binding.tvDr.setOnClickListener(v->{
            ...
            transaction.replace(R.id.dr, storeDrFragment);
        ...
        binding.tvRing.setOnClickListener(v->{
            ...
            transaction.replace(R.id.dr, storeRiFragment);
        ...
        binding.tvGift.setOnClickListener(v->{
            ...
            transaction.replace(R.id.dr, storeGiFragment);
        ...
        binding.tvEtc.setOnClickListener(v->{
            ...
            transaction.replace(R.id.dr, storeEtcFragment);
    ...
    public void select(String order) {
        CommonConn conn = new CommonConn(getContext(), "storelist_dr");
