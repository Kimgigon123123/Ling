...
//            ll.setBackgroundColor(Color.BLACK);
        ...
        binding.tvHome.setOnClickListener(v -> {
            ...
            transaction.replace(R.id.gi, newFragment);
        ...
        binding.tvAll.setOnClickListener(v -> {
            ...
            transaction.replace(R.id.gi, storeCoFragment);
        ...
        binding.tvDr.setOnClickListener(v->{
            ...
            transaction.replace(R.id.gi, storeDrFragment);
        ...
        binding.tvRing.setOnClickListener(v->{
            ...
            transaction.replace(R.id.gi, storeRiFragment);
        ...
        binding.tvGift.setOnClickListener(v->{
            ...
            transaction.replace(R.id.gi, storeGiFragment);
        ...
        binding.tvEtc.setOnClickListener(v->{
            ...
            transaction.replace(R.id.gi, storeEtcFragment);
    ...
    public void select(String order) {
        CommonConn conn = new CommonConn(getContext(), "storelist_gi");
...
//    public void by_name() {
//        CommonConn conn = new CommonConn(getContext(), "store_gi_byname");
//        conn.onExcute((isResult, data) -> {
//
//            ArrayList<StoreCOVO> list = new Gson().fromJson(data, new TypeToken<ArrayList<StoreCOVO>>() {
//            }.getType());
...
//        CommonConn conn = new CommonConn(getContext(), "store_gi_bypopular");
//        conn.onExcute((isResult, data) -> {
//
//            ArrayList<StoreCOVO> list = new Gson().fromJson(data, new TypeToken<ArrayList<StoreCOVO>>() {
//            }.getType());
...
//        CommonConn conn = new CommonConn(getContext(), "store_gi_byprice");
//        conn.onExcute((isResult, data) -> {
//
//            ArrayList<StoreCOVO> list = new Gson().fromJson(data, new TypeToken<ArrayList<StoreCOVO>>() {
//            }.getType());
