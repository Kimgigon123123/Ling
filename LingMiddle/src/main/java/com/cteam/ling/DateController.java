...
public class DateController {
	...
	public String allDibs(String id , String category) {
		...
		params.put("id", id);
		params.put("date_category_code", category);
		List<DateDibsVO> list = sql.selectList("date.selectdibs", params);
	...
	public String date_countList(String category , int count) {
		...
		List<DateInfoVO> list = sql.selectList("date.countList",param);
		return new Gson().toJson(list);
	}
